// https://youtube.com/@viradesigner
import { connect } from 'cloudflare:sockets';

let userID = '2721ea0c-9f69-41aa-994e-1db318adbe73';
...
function getVLESSConfig(userID, hostName) {
  const wvlessws = `vless://${userID}@www.YourDomain.com:8880?encryption=none&security=none&type=ws&host=${hostName}&path=%2F%3Fed%3D2048#${hostName}`;
  const pvlesswstls = `vless://${userID}@www.YourDomain.com:8443?encryption=none&security=tls&type=ws&host=${hostName}&sni=${hostName}&fp=random&path=%2F%3Fed%3D2048#${hostName}`;
...
For More Video: https://youtube.com/@viradesigner
...
-------------------------------------------------- -------------
Note: The camouflaged domain name (host) of the client option must be changed to the custom domain name you completed in CF resolution
-------------------------------------------------- -------------
The required civilization parameters of the client are as follows:
Client address (address): Custom domain name or preferred domain name or preferred IP (reverse IP must correspond to reverse port)
Port: 6 https ports can be selected arbitrarily (443, 8443, 2053, 2083, 2087, 2096)
